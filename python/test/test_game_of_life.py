...
class GameOfLifeTest(unittest.TestCase):
    ...
    def test_the_board_extends_left_and_bot_if_a_cell_is_brought_to_life_on_both_sides(self):
        board = [
            [ True, False, True ],
            [ True, False, False ],
            [ True, True, True ]
    ...
    def test_the_board_extends_left_right_and_top_if_a_cell_is_brought_to_life_on_those_sides(self):
        board = [
            [ True, True, True ],
            [ True, False, True ],
            [ True, False, True ]
    ...
    def test_the_board_extends_left_right_and_bot_if_a_cell_is_brought_to_life_on_those_sides(self):
        board = [
            [ True, False, True ],
            [ True, False, True ],
            [ True, True, True ]
    ...
    def test_the_board_extends_left_bot_and_top_if_a_cell_is_brought_to_life_on_those_sides(self):
        board = [
            [ True, True, True ],
            [ True, False, False ],
            [ True, True, True ]
    ...
    def test_the_board_extends_right_bot_and_top_if_a_cell_is_brought_to_life_on_those_sides(self):
        board = [
            [ True, True, True ],
            [ False, False, True ],
            [ True, True, True ]
    ...
    def test_the_board_extends_on_all_sides_if_a_cell_is_brought_to_life_on_all_sides(self):
        board = [
            [ True, True, True ],
            [ True, False, True ],
            [ True, True, True ]
